 ...
 * Generated at: 2019-07-13 08:48:45 UTC
...
public final class box_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String userProfile = userDAO.getProfile(userID); // profile의 경로를 가져오는 메서드
      ...
      out.write("\t\t\t\t\tif(result >= 1) { // 읽지않은 메세지 개수가 1개 이상일때\r\n");
      ...
      out.write("\t\t\t\t\tvar parsed = JSON.parse(data); // JSON형식을 파싱한다\r\n");
      ...
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\taddBox(result[i][0].value1, result[i][0].value2, result[i][0].value3, result[i][0].value4, result[i][0].value5, result[i][0].value6);\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tfunction addBox(lastID, toId, chatContent, chatTime, unread, profile) {\r\n");
      out.write("\t\t\t$('#boxTable').append('<tr onclick=\"location.href=\\'chat.jsp?toID=' + toId + '\\'\">' +\r\n");
      out.write("\t\t\t\t\t'<td style=\"width: 150px;\">' +\r\n");
      out.write("\t\t\t\t\t'<img class=\"media-object img-circle\" style=\"margin: 0 auto; max-width: 40px; max-height: 40px;\" src=\"' + profile + '\"></img>' +\r\n");
      out.write("\t\t\t\t\t'<h5>' + lastID + '</h5></td>' +\r\n");
      out.write("\t\t\t\t\t'<td>' +\r\n");
